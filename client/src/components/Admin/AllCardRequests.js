...
function AllJourneys() {
  ...
  return (
    <div className="ml-5" style={{marginLeft: "50px"}}>
        ...
        <Card.Header>{index+1}.  <strong>Request ID - {booking._id}</strong> </Card.Header>
        <Card.Body>
          ...
          <Card.Text>
            Requsted at {booking.createdAt.substring(0,10)} , {booking.createdAt.substring(11,16)} 
            <div className="row mt-2">
            
                <div className="col-6 md-4">
                    <button className="btn btn-danger" id={booking._id} onClick={(e)=> deleteBookings(e)}>Cancel Request</button>
                    </div>
        ...
        </div> :  <div><p>No Card Requests</p></div> }
